 ...
 * Features:
 * - Expandable search input dengan animasi
 * - Recent searches dengan localStorage
 * - Search suggestions
...
const SearchBar = ({ onClose }) => {
  ...
  const handleSearch = (searchText = query) => {
    ...
    // Redirect ke search results atau lakukan API call
  ...
  return (
    ...
    >
      {/* Search Container dengan Glass Effect */}
      <div 
